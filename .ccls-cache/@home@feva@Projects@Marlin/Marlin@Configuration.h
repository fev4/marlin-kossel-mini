...
#define STRING_CONFIG_H_AUTHOR "Luis" // Who made the changes.
...
// Ultimaker
#define DEFAULT_Kp 26.17
#define DEFAULT_Ki 1.55
#define DEFAULT_Kd 110.41
...
#define DELTA_HEIGHT 234.56 // (mm) Get this value from G33 auto calibrate
...
#define DELTA_RADIUS 100 // (mm) Get this value from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT                                                               \
  {                                                                                               \
    DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 760 * 1.1 \
...
#define Z_PROBE_ALLEN_KEY_STOW_2                       \
  {                                                    \
    -64.0, 56.0, 23.0 - (Z_PROBE_ALLEN_KEY_STOW_DEPTH) \
  }
...
#define Z_PROBE_ALLEN_KEY_STOW_4                    \
  {                                                 \
    0.0, 0.0, 23.0 + (Z_PROBE_ALLEN_KEY_STOW_DEPTH) \
  }
